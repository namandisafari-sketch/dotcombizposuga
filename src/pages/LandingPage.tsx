...
export default function LandingPage() {
  const {
    ...
    queryFn: () => localApi.landingPageContent.getAll(),
  });
  const {
    data: services
  } = useQuery({
    queryKey: ["service-showcase"],
    queryFn: () => localApi.serviceShowcase.getAll(),
  });
  const {
    data: settings
  } = useQuery({
  ...
  return <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      {hero && <section className="relative py-32 px-4 bg-cover bg-center bg-no-repeat" style={{
      backgroundImage: `url(${heroBanner})`
    }}>
          <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px]" />
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="text-center space-y-6">
              <Badge variant="secondary" className="mb-4 text-foreground bg-[#0a1f11]">
      ...
      {/* Services Section */}
      {servicesSection && <section id="services" className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            return <Card key={service.id} className="hover:shadow-lg transition-shadow">
                    <CardHeader>
      ...
      {/* About Section */}
      {about && <section className="py-20 px-4 bg-muted/50">
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-4xl font-bold">{about.title}</h2>
                <p className="text-xl text-primary">{about.subtitle}</p>
      ...
      {/* Contact Section */}
      {contactSection && <section id="contact" className="py-20 px-4">

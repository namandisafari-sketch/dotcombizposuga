...
const MobileMoneyDashboard = () => {
  ...
  const { data: todaySales = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      const salesData = await localApi.sales.getAll({
      ...
      return salesData.filter((sale: any) => sale.status !== 'voided');
    },
    enabled: !!selectedDepartmentId,
  });

  // Fetch all sales for overview
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              UGX {todayRevenue.toLocaleString()}
            </div>

...
const Navigation = () => {
  ...
  const allNavItems: NavItem[] = [{
    ...
    departments: ["general", "mobile money", "perfume"]
  }, {
    path: "/expenses",
    icon: Receipt,
    label: "Expenses",
    ...
    path: "/perfume-dashboard",
    icon: LayoutDashboard,
    label: "My Shop",
    departments: ["perfume"]
  }, {
    path: "/perfume-analytics",
    icon: Sparkles,
    label: "Perfume Analytics",
    departments: ["perfume"]
  }, {
    path: "/perfume-inventory",
    icon: Droplet,
    label: "Perfume Inventory",
    departments: ["perfume"]
  }, {
    path: "/perfume-revenue",
    icon: TrendingUp,
    label: "Perfume Revenue",
    departments: ["perfume"]
  }, {
    path: "/scent-popularity",
    icon: BarChart3,
    label: "Scent Tracker",
    departments: ["perfume"]
  }, {
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-card border-b shadow-sm">
